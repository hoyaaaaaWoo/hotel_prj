...
location.href="http://localhost/hotel_prj/admin/admin_member/admin_member_select.jsp";
</script>	
<%}else{%>
<script type="text/javascript">
	alert("이미 삭제된 회원입니다..");
...
<c:if test="${not empty e}">
	...
	<a href="http://localhost/hotel_prj/admin/admin_member/admin_member_select.jsp">뒤로 가기</a>
</c:if>
</body>
</html>