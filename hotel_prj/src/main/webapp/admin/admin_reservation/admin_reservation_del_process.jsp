...
<script type="text/javascript">
	...
	location.href="http://localhost/hotel_prj/admin/admin_reservation/admin_reservation_main.jsp";
</script>
<%} else {%>
<script type="text/javascript">
...
<c:if test="${not empty e}">
	...
	<a href="http://localhost/hotel_prj/admin/admin_reservation/admin_reservation_main.jsp">뒤로 가기</a>
</c:if>
</body>
</html>