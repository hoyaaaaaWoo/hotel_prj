  ...
  <body>
    ...
    <table style="margin: 0px auto;">
    	...
    	<tr >
    		...
    		<td><a href="http://team3.aws.sist.co.kr/user/login/signIn.jsp" style="color: #C0C0C0">&nbsp;&nbsp;회원가입&nbsp;&nbsp;</a>
    		<a href="http://team3.aws.sist.co.kr/user/login/find.jsp" style="color: #C0C0C0">아이디/비밀번호 찾기</a></td>
    	</tr>
    </table>
    </form>
