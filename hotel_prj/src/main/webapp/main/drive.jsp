	...
	<div class="wrapper">
		...
		<div class="container marketing" style="width: 1130px;">
			...
			<div style="text-align: center">
				...
				<br /> <img
					src="http://localhost/hotel_prj/main/main_images/dining_main.jpg"
					width="1000"><br /> <br /> <br />
				...
				<table class="driveTab">
					<tr class="driveTr">
						...
						<td class="storeImg"><img
							src="http://localhost/hotel_prj/main/main_images/dining_momo.jpg" />
						</td>
					</tr>
					<tr class="driveTr">
						<td class="storeInfo"><span><strong>업장명</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							href="#void">자세히 보기 > </a></td>
						<td class="storeImg"><img
							src="http://localhost/hotel_prj/main/main_images/dining_mu.jpg" />
						</td>
					</tr>
					<tr class="driveTr">
						<td class="storeInfo"><span><strong>업장명</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							href="#void">자세히 보기 > </a></td>
						<td class="storeImg"><img
							src="http://localhost/hotel_prj/main/main_images/dining_delica.jpg" />
						</td>
					</tr>
					<tr class="driveTr">
						<td class="storeInfo"><span><strong>업장명</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							href="#void">자세히 보기 > </a></td>
						<td class="storeImg"><img
							src="http://localhost/hotel_prj/main/main_images/dining_do.jpg" />
						</td>
					</tr>
					<tr class="driveTr">
						<td class="storeInfo"><span><strong>업장명</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							href="#void">자세히 보기 > </a></td>
						<td class="storeImg"><img
							src="http://localhost/hotel_prj/main/main_images/dining_la.jpg" />
						</td>
					</tr>
					<tr class="driveTr">
